...
function forecast(city) {
  var requestUrl = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&units=imperial&appid=72196e67318ffa654665dd9cccf2f44c`;
...
function current(city) {
  var requestUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=imperial&appid=72196e67318ffa654665dd9cccf2f44c`;
